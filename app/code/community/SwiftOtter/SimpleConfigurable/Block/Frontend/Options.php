...
{
    /**
     * Composes configuration for js. An unfortunate override of base functionality, but necessary in that we are
     * thus able to provide some excellent functionality.
     *
     * @return string
     */
    public function getJsonConfig()
    {
        ...
        $config = array(
            ...
            'maxPrice'          => $this->_registerJsPrice($this->_convertPrice($currentProduct->getPriceModel()->getMaxPossibleFinalPrice($currentProduct))),
            'minPrice'          => $this->_registerJsPrice($this->_convertPrice($currentProduct->getFinalPrice())),
